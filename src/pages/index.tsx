  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to the Mobile Store, your comprehensive solution for effortless mobile store inventory management. Streamline your operations, optimize your processes, and enhance your business efficiency with us."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to the Mobile Store, your comprehensive solution for effortless mobile store inventory management. Streamline your operations, optimize your processes, and enhance your business efficiency with us.`}
            </Text>
            <Box
