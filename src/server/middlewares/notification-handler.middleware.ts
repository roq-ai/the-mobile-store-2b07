...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'order_placed.create': { roles: ['owner', 'manager'], key: 'order_id', tenantPath: [], userPath: [] },
  'payment_received.create': { roles: ['owner', 'manager'], key: 'payment_id', tenantPath: [], userPath: [] },
  'inventory_updated.update': { roles: ['owner', 'manager'], key: 'inventory_id', tenantPath: [], userPath: [] },
};
